...
class GridNN {
   public:
    ...
    explicit GridNN(float resolution = 0.1, NearbyType nearby_type = NearbyType::NEARBY4)
        ...
        } else if (dim == 3 && (nearby_type_ != NearbyType::NEARBY14 && nearby_type_ != NearbyType::NEARBY6 && nearby_type_ != NearbyType::CENTER)) {
 ...
 * 
 * @tparam dim 
 * @param ref -> first_pointcloud
 * @param query -> second_pointcloud
 * @param matches 
 * @return true 
 * @return false 
 */
